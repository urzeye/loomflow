...
/**
 * LoomFlow 上下文包装的 Runnable。
 *
 * @since 0.3.0
 */
public final class FlowRunnable implements Runnable, LoomFlowWrapped {

    private final ContextCarrier carrier;
    private final Runnable task;

    public FlowRunnable(ContextCarrier carrier, Runnable task) {
